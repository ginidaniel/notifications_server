...
import services.notifications.NotificationsService;
...
public class NotificationSender {
    ...
    public static void main (String[] args) {
        notificationsService.fetchPending(NotificationSender::handleNotifications);
    }
    ...
    private static List<String> removeLaterTargets(Notification notification, Map<String, UserNotifications> targeted) {
        ...
        for (String username : targeted.keySet())
            if (filterPushLater(notification.getType(), targeted.get(username).getTimeZone()))
                usernames.add(username);
